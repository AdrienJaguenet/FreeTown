			...
			layers = {
				isoTile(terrain_tilemap, 1, 2),
				{
					oriented = {
						...
						['0001'] = isoTile(terrain_tilemap,  2, 5),
						['0010'] = isoTile(terrain_tilemap, 10, 5),
						['0011'] = isoTile(terrain_tilemap,  4, 5),
						['0100'] = isoTile(terrain_tilemap,  1, 5),
						['0101'] = isoTile(terrain_tilemap,  3, 5),
						['0110'] = isoTile(terrain_tilemap, 11, 5),
						['0111'] = isoTile(terrain_tilemap,  5, 5),
						['1000'] = isoTile(terrain_tilemap, 14, 5),
						['1001'] = isoTile(terrain_tilemap,  8, 5),
						['1010'] = isoTile(terrain_tilemap, 12, 5),
						['1011'] = isoTile(terrain_tilemap,  6, 5),
						['1100'] = isoTile(terrain_tilemap, 15, 5),
						['1101'] = isoTile(terrain_tilemap,  9, 5),
						['1110'] = isoTile(terrain_tilemap, 13, 5),
						['1111'] = isoTile(terrain_tilemap,  7, 5),
					}
				},
			},
		},
